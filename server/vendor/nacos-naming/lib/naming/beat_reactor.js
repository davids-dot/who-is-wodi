...
class BeatReactor extends Base {
    ...
    _buildKey(dom, ip, port) {
        return dom + const_1.NAMING_INSTANCE_ID_SPLITTER + ip + const_1.NAMING_INSTANCE_ID_SPLITTER + port;
    }
    async _beat(beatInfo) {
        if (beatInfo.scheduled)
            return;
...
exports.BeatReactor = BeatReactor;
//# sourceMappingURL=beat_reactor.js.map